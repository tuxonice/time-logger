...
class Web implements RouteInterface
{
    public static function routes(RouteCollector $r): void
    {
        ...
        $r->addRoute('PUT', '/projects/{projectId}/tasks/{taskId}/bookings/end', ['TimeLogger\Controllers\BookingController','end']);
        $r->addRoute('GET', '/projects/{projectId}/tasks/{taskId}/bookings/list', ['TimeLogger\Controllers\BookingController','list']);
        $r->addRoute('GET', '/projects/{projectId}/tasks/{taskId}/booking/{bookingId}', ['TimeLogger\Controllers\BookingController','read']);
        $r->addRoute('DELETE', '/projects/{projectId}/tasks/{taskId}/booking/{bookingId}', ['TimeLogger\Controllers\BookingController','delete']);
    }
}
